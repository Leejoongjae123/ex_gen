    ...
    <Layout style={{ backgroundColor: "#eee" }}>
      ...
      >
        <Space style={{ display: "flex", flexDirection: "column" }}>
          {isVisitors ? (
            <BarChartComp visitors={visitors}></BarChartComp>
          ) : (
            <Space
              style={{
                width: "100vw",
        ...
        >
          ...
          {isLoading ? (
            <CardLayout isLoading={isLoading} articles={articles}></CardLayout>
          ) : (
            <Space
              style={{
                width: "100vw",
